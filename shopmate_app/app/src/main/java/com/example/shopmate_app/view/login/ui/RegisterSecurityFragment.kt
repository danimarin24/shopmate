 ...
 * Use the [RegisterSecurityFragment.newInstance] factory method to
...
class RegisterSecurityFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegisterSecurityFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegisterSecurityFragment().apply {
